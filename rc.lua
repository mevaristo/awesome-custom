...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "s",
                function () awful.util.spawn("sh /home/mevaristo/.config/awesome/sh_scripts/screenshot.sh") end,
                {description = "take a screenshot", group = "custom"}),
    --- [custom] XRandR helper
    awful.key({ modkey, "Shift" }, "d",
                function () xrandr.xrandr() end,
                {description = "Rearrange display", group = "custom"}),
    --- [custom] Lock screen
    awful.key({ modkey }, "l",
