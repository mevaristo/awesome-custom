...
beautiful.init("/home/mevaristo/.config/awesome/themes/custom/theme.lua")
...
--- [custom] Take screenshot (to clipboard)
                              awful.key({modkey, "Shift"}, "s", function()
    awful.util.spawn(
        "sh /home/mevaristo/.config/awesome/sh_scripts/screenshot.sh")
end, {description = "take a screenshot", group = "custom"}),
--- [custom] XRandR helper
--                               awful.key({modkey, "Shift"}, "d",
--                                         function() xrandr.xrandr() end, {
--     description = "Rearrange display",
--     group = "custom"
-- }), 
--- [custom] Lock screen
awful.key({ modkey }, "l",
          function() awful.util.spawn("xlock -mode noof -dpmsstandby 30") end,
          {description = "Lock screen", group = "custom"}),
--- [custom] Multimedia and volume buttons
awful.key({ }, "XF86AudioRaiseVolume",
          function() awful.util.spawn("amixer -D pulse sset Master 2%+") end,
...
awful.key({ }, "XF86AudioStop",
          ...
          {description = "Stop media", group = "custom"}),
awful.key({ }, "XF86AudioNext",
          function() awful.util.spawn("playerctl next") end,
          {description = "Next media track", group = "custom"}),
awful.key({ }, "XF86AudioPrev",
          function() awful.util.spawn("playerctl previous") end,
          {description = "Previous media track", group = "custom"}),
--- [custom] Rofi as launcher
awful.key({ modkey }, "d",
          function() awful.util.spawn("rofi -show combi -modes combi -combi-modes \"window,drun,run\" -config /home/mevaristo/.config/rofi/dark.rasi") end,
          {description = "Run rofi", group = "custom"}),
--- [custom] Color picker to clipboard
awful.key({ modkey }, "c",
          function() awful.util.spawn("sh /home/mevaristo/.config/awesome/sh_scripts/color_picker.sh") end,
          {description = "Run color picker", group = "custom"})
        )
...
awful.key({modkey, "Shift"}, "c",
        ...
        description = "close",
        group = "client"}), 
--- [custom] Alternative close
awful.key({ modkey }, "F4",
        function(c) c:kill() end, {
        description = "close alternative 2",
        group = "custom"}), 
...
-- [custom] Screen move from site
                              awful.key({modkey}, "Next", function(c)
    c:relative_move(20, 20, -40, -40)
end), awful.key({modkey}, "Prior",
                function(c) c:relative_move(-20, -20, 40, 40) end), awful.key(
                                  {modkey}, "Down",
...
end), awful.key({modkey}, "Right", function(c) c:relative_move(20, 0, 0, 0) end))
