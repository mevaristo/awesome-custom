...
--customized by me
local screenshot = 'import -window root ~/Pictures/screenshots/print.$(date +"%Y%m%d_%H%M%S").png'
...
globalkeys = my_table.join(
    ...
    awful.key({ }, "XF86AudioRaiseVolume", function() os.execute(volume_up) end,
    	      {description = "raise volume (amixer)", group = "hotkeys"}),

    awful.key({ }, "XF86AudioLowerVolume", function() os.execute(volume_down) end,
              {description = "lower volume (amixer)", group = "hotkeys"}),
